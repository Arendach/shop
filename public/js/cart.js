...
window.Cart = {
  attach: function () {
    ...
    /*#__PURE__*/
    _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(id, selector) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return axios__WEBPACK_IMPORTED_MODULE_1___default.a.post('/catalog/cart/attach', {
                id: id
  ...
  detach: function () {
    ...
    /*#__PURE__*/
    _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2(id, selector) {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 2:
              selector.disabled = true;
              _context2.next = 5;
              return axios__WEBPACK_IMPORTED_MODULE_1___default.a.post('/catalog/cart/detach', {
                id: id
              }).then(function (response) {
                var _response$data$messag2, _response$data$title2;
    ...
    function detach(_x3, _x4) {
      return _detach.apply(this, arguments);
    }

    return detach;
  }(),
  switchDesire: function () {
    var _switchDesire = _asyncToGenerator(
    /*#__PURE__*/
    _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee3(product_id, selector) {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 2:
              selector.disabled = true;
              _context3.next = 5;
              return axios__WEBPACK_IMPORTED_MODULE_1___default.a.post('catalog/desire/switch', {
    ...
    function switchDesire(_x5, _x6) {
      return _switchDesire.apply(this, arguments);
    }
...
$(document).on('click', '[data-type="cart_detach"]', function () {
  var id = $(this).data('id');
  axios__WEBPACK_IMPORTED_MODULE_1___default.a.post('/catalog/cart/detach', {
    id: id
  }).then(function (response) {
    var _response$data$messag4, _response$data$title4;
...
$(document).on('click', '[data-type="cart_page_detach"]', function () {
  ...
  axios__WEBPACK_IMPORTED_MODULE_1___default.a.post('/catalog/cart/detach', {
    ...
    var _response$data$messag5, _response$data$title5;

    $(_this).parents('tr').remove();
    $('.dropdown-cart-count').html(response.data.cartContProducts);
    $('.dropdown-cart-sum').html(response.data.cartSumProducts);
    toastr.success((_response$data$messag5 = response.data.message) !== null && _response$data$messag5 !== void 0 ? _response$data$messag5 : '', (_response$data$title5 = response.data.title) !== null && _response$data$title5 !== void 0 ? _response$data$title5 : undefined);
  });
});
...
/***/ 0:
/*!*****************************************************************!*\
  !*** multi ./resources/js/cart.js ./resources/sass/custom.scss ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
