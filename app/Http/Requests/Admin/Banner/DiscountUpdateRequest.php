...
class DiscountUpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'name_uk' => 'required',
            'name_ru' => 'required',
            'image_min_uk' => 'nullable|dimensions:width=60,height=60',
            'image_min_ru' => 'nullable|dimensions:width=60,height=60',
            'image_second_uk' => 'nullable|dimensions:width=600,height=400',
            'image_second_ru' => 'nullable|dimensions:width=600,height=400',
            'image_max_uk' => 'nullable|dimensions:width=1200,height=600',
            'image_max_ru' => 'nullable|dimensions:width=1200,height=600',
        ];
    }
