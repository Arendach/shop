...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-nova-packing-field', __webpack_require__(3));
  Vue.component('detail-nova-packing-field', __webpack_require__(6));
  Vue.component('form-nova-packing-field', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        fill: function fill(formData) {
            formData.append(this.field.attribute, JSON.stringify([this.firstRow, this.secondRow, this.lastRow]));
        },
          ...
          _c("input", {
            ...
            on: {
              input: function($event) {
                ...
                _vm.secondRow = $event.target.value
              }
            }
          })
        ]),
