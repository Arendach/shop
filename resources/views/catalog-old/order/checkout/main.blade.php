        ...
        <div class="row">
            <div class="col-6">
                <div class="checkout-page">
                    ...
                    <form id="checkout">
                        @include('catalog-old.order.checkout.steps.contacts')

                        @include('catalog-old.order.checkout.steps.delivery', compact('order_types'))

                        @include('catalog-old.order.checkout.steps.pay')

                        @include('catalog-old.order.checkout.steps.more')
                    </form>
            ...
            <div class="col-6">
                <div class="checkout-products">
                    ...
                    @include('catalog-old.order.checkout.products')
