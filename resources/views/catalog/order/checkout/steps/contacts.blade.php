...
@if (!is_auth())
    <div class="form-group">
        <button id="btn-reg-user" type="button" class="btn btn-outline-info w-100">Авторизуватись</button>

        <div class="help-block" style="font-size: 14px; color: #ccc; padding: 5px 5px 0;">
            <span id="help-new-user">
                * Якщо ви не зарестровані то реєстрація пройде автоматично
            </span>
        </div>
    </div>
@endif
...
<div class="form-group">
    <label> <i class="text-danger">*</i> Ваше імя</label>
...
<div class="form-group">
    <label> <i class="text-danger">*</i> Ваш E-Mail</label>
...
<div class="form-group">
    <label> <i class="text-danger">*</i> Номер телефону</label>
